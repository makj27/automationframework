...
@Log4j
public class BRLoginPage extends BaseLoginPage {
    ...
    //Constructor
    public BRLoginPage(RemoteWebDriver driver, Properties globalFWProp, Properties programFWProp,
    ...
    public void validateHomeTitle(String file) throws FileNotFoundException {
        //Brazil specific login validation
        LoggerUtil.logEntryForPageMethod(new Exception(),log);
